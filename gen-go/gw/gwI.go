...
type GatewayI interface {
  ...
  //  - Cid
  //  - Gid
  Last(ctx context.Context, cid int64, gid string) (_r Result_, _err error)
  // Parameters:
  //  - Cid
  //  - URI
  //  - Bytes
...
//  - Cid
//  - Gid
func (p *GatewayIClient) Last(ctx context.Context, cid int64, gid string) (_r Result_, _err error) {
...
func (p *gatewayIProcessorLast) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var retval Result_
  if retval, err2 = p.handler.Last(ctx, args.Cid, args.Gid); err2 != nil {
    tickerCancel()
    if err2 == thrift.ErrAbandonRequest {
      return false, thrift.WrapTException(err2)
    }
